...
namespace WeddingManagementApplication
{
    internal class WeddingClient
    {
        ...
        internal static string sqlConnectionString = @"Server=DESKTOP-673E813\OSBORN;Database=WEDDINGMANAGEMENT;Integrated Security=True";
            //ConfigurationManager.AppSettings.Get("An");
